...
def main(cfg):
    ...
    if cfg.detector == "retinaface":
        ...
        landmarks_detector = LandmarksDetector()
    dataloader = AVSRDataLoader(modality="video", speed_rate=1,
                                transform=False, detector=cfg.detector, convert_gray=False)
    ...
    print(
        f"The mouth images have been cropped and saved to {cfg.dst_filename}")
